                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="./index.html" class="text-nowrap logo-img text-center d-block py-3 w-100">
                                    <img src="{{ asset('dashboard/assets/images/logos/dark-logo.svg') }}" width="180"
                                        alt="">
                                </a>
                                ...
                                <form action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="username" class="form-control"
                                            id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan Username" value="{{ old('username')}}" >
                                            @error('username')
